...
# โหลด YOLOv8 model
model = YOLO(r'/mnt/c/Users/Best_ryker/Desktop/Work/Year4term1/pattern-recognition/Cardamage(github)/Cardamage-pattern-recognition/modelver40.1.50/Cardamagebypart_ver40.1.50.pt')
